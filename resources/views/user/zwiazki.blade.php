            ...
            <div class="row">
                <div class="col-12 col-md-3 order-2 order-md-1 my-4">
                    <div class="service-s__left">
                        ...
                        <ul>
                            ...
                            <li><a href="{{route('zwiazki')}}"  class="active">Związki i Kluby </a></li>
                ...
                <div class="col-12 col-md-9 order-1 order-md-2 my-4">
                    <div class="service-s__right">
                        <h1>Związki | Kluby | Ośrodki sportowe i turystyczne</h1>
                        <p>Sport wyczynowy nie istniałby, gdyby nie organizacje
                            rynku sportowego prowadzące zawodników, regulujące
                            zasady współzawodnictwa i dbające o bezpieczeństwo w
                            sporcie. Wspieramy związki sportowe, kluby i inne
                            podmioty rynku sportowego w ich bieżącej działalności</p>
                        
                        <p class="strong">Wybrane usługi dla Zawodników:</p>
                        <ol>
                            <li>Zakładanie organizacji sportowych</li>
                            <li>Sporządzanie regulacji wewnątrzorganizacyjnych (statuty, regulaminy, uchwały)</li>
                            <li>Sporządzanie i opiniowanie umów</li>
                            <li>Prawo pracy i HR</li>
                            <li>Obsług prawna ośrodków sportowych i turystycznych</li>
                            <li>Działalność gospodarcza w sporcie i turystyce</li>
                            <li>Ochrona konkurencji w sporcie i turystyce</li>
                            <li>Legislacja klubowa i związkowa</li>
                            <li>Reprezentowanie klubów przed sądami i organami</li>
                            <li>Odpowiedzialność cywilna i karna za wypadki w sporcie</li>
                        </ol>
                    </div>
                </div>
            </div>
